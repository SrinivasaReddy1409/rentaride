...
public class mumbairequest extends riderequest{
	public void mumbairequest() {
		...
		String[] cartypes= {"Sedan","Hatchback","5 Seater","Sedan","Hatchback"};
